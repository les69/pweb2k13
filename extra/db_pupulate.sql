...
INSERT INTO PWEB.POST (VISIBLE, DATE_POST, MESSAGE, ID_GROUP, ID_USER, VISIBLE) VALUES (DEFAULT, CURRENT_TIMESTAMP, 'We must exterminate the doctor!!', 1, 1, true);
INSERT INTO PWEB.POST (VISIBLE, DATE_POST, MESSAGE, ID_GROUP, ID_USER, VISIBLE) VALUES (DEFAULT, CURRENT_TIMESTAMP, 'I obey. Exterminate!', 1, 6, true);
INSERT INTO PWEB.POST (VISIBLE, DATE_POST, MESSAGE, ID_GROUP, ID_USER, VISIBLE) VALUES (DEFAULT, CURRENT_TIMESTAMP, 'Ohai! I''m Boxxy, you see?',3, 3, true);
